...
gcc -Wall -Wextra demo_program.c -o demo_warnings
...
echo -e "\n5. Strict compilation (treat warnings as errors):"
echo "   gcc -Wall -Wextra -Werror demo_program.c -o demo_strict"
echo "   (This will fail due to warnings)"

# Clean up
rm -f demo_program.c demo_basic demo_warnings demo_debug demo_optimized

echo -e "\nKey GCC flags for validation code:"
echo "  -Wall        : Enable common warnings"
echo "  -Wextra      : Enable extra warnings"
echo "  -Werror      : Treat warnings as errors"
echo "  -g           : Include debugging information"
echo "  -O2          : Optimize for performance"
echo "  -std=c99     : Use C99 standard"