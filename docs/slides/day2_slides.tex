...
\begin{center}
% the table goes over the boundary too large to the right side
\begin{tabular}{|l|l|l|}
\hline
...
\begin{center}
% the tikz picture return tpe and function name is crashing into one another and the block boundary shifts to the right too much and crosses the boundary
\begin{tikzpicture}
