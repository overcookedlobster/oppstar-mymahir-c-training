...
\begin{itemize}
    ...
    \item \textbf{Day 4:} Cross-compilation, MicroBlaze-V
...
\begin{columns}
\begin{column}{0.6\textwidth}
\textbf{MicroBlaze-V Platform Benefits:}
\begin{itemize}
    ...
    \item \textcolor{courseblue}{\textbf{Excellent Documentation:}} Comprehensive MicroBlaze-V SDK and examples
\end{itemize>
...
\node at (1.5,1.7) {\textbf{MicroBlaze-V}};
...
\begin{itemize}
    \item 20 MicroBlaze-V boards: \$100
    \item USB cables: \$30
    \item Accessories: \$20
...
\node[draw, rectangle, fill=coursered!20] at (2,1.5) {MicroBlaze-V};
...
\begin{itemize}
    \item Hardware (20 MicroBlaze-V kits): \$150
...
\begin{itemize}
    ...
    \item \textcolor{courseblue}{\textbf{Real Hardware:}} Hands-on MicroBlaze-V experience
